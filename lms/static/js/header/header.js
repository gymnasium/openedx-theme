...
if (typeof jQuery !== "undefined" && jQuery !== null) {
  $(document).ready(function () {
    ...
    $(".global-header .toggle-user-dropdown, .global-header .toggle-user-dropdown span").on('click', function (e) {
    ...
    $(".global-header .hamburger-menu").on('click', function () {
    ...
    $(".mobile-menu, .global-header").on("keydown", function (e) {
      ...
      if (
        ...
        if (isHamburgerMenu) {
          ...
          if (
            $(".global-header .nav-item .dropdown-user-menu").is(":visible")
          ) {
            $userDropdown.attr("aria-expanded", "true");
      ...
      if (
        ...
        (isDropdownOption ||
          isMobileOption ||
          (isHamburgerMenu && $hamburgerMenu.hasClass("open")) ||
          (isToggle && $toggleUserDropdown.hasClass("open")))
      ) {
        ...
        if (isNext && !isHamburgerMenu && !isToggle && isLastItem) {
          ...
          nextLink = isHamburgerMenu
            ? $(".mobile-menu .mobile-nav-link a").last()
            : $(".global-header .dropdown-user-menu .dropdown-nav-item")
                .last()
                .find("a");
        } else if (isNext && (isHamburgerMenu || isToggle)) {
          // Loop to the first element from the menu icon
          nextLink = isHamburgerMenu
            ? $(".mobile-menu .mobile-nav-link a").first()
            : $(".global-header .dropdown-user-menu .dropdown-nav-item")
                .first()
                .find("a");
        } else {
          ...
          if (
            !isNext &&
            $curTarget.parent().is(":first-child") &&
            !isHamburgerMenu &&
            !isToggle
          ) {
            nextLink = isDropdownOption ? $toggleUserDropdown : $hamburgerMenu;
      ...
      if (
        e.key === "Escape" &&
        (isDropdownOption || isHamburgerMenu || isMobileOption || isToggle)
      ) {
        if (isDropdownOption || isToggle) {
          $(".global-header .nav-item .dropdown-user-menu").addClass("hidden");
          $toggleUserDropdown.focus().attr("aria-expanded", "false");
      ...
      if (
        e.key === "Tab" &&
        ((isDropdownOption && isLastItem) ||
          (isMobileOption && isLastItem) ||
          (isHamburgerMenu && $hamburgerMenu.hasClass("open")) ||
          (isToggle && $toggleUserDropdown.hasClass("open")))
      ) {
        nextLink = null;
        ...
        if (isDropdownOption || isToggle) {
          nextLink = loopFirst
            ? $toggleUserDropdown
            : $(
                ".global-header .dropdown-user-menu .dropdown-nav-item a"
              ).last();
        } else {
          nextLink = loopFirst
            ? $hamburgerMenu
